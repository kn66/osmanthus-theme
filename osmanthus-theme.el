...
;;
;; Popular third-party packages are also styled explicitly.  These include
;; Magit and Transient as well as the Vertico, Consult, Marginalia, Corfu,
;; Cape, Embark, and Tempel completion stack.
...
(let (
      ...
      (bg-alt (alist-get 'bg-alt osmanthus-palette))
      ...
      (bg-orange (alist-get 'bg-orange osmanthus-palette))
  ...
  (custom-theme-set-faces
   ...
   `(transient-active-infix ((t (:foreground ,navy-dark :background ,bg-region :weight semibold))))
   `(transient-argument ((t (:foreground ,pink :weight bold))))
   `(transient-delimiter ((t (:foreground ,fg-faint))))
   `(transient-disabled-suffix ((t (:foreground ,red-dark :background ,bg-red))))
   `(transient-enabled-suffix ((t (:foreground ,water-dark :background ,bg-blue :weight semibold))))
   `(transient-heading ((t (:foreground ,gold-dark :weight bold))))
   `(transient-higher-level ((t (:foreground ,violet :weight semibold))))
   `(transient-inactive-argument ((t (:foreground ,fg-faint))))
   `(transient-inactive-value ((t (:foreground ,fg-faint))))
   `(transient-inapt-argument ((t (:foreground ,fg-faint :weight semibold))))
   `(transient-inapt-suffix ((t (:foreground ,fg-faint :slant italic))))
   `(transient-key ((t (:foreground ,navy :weight bold))))
   `(transient-key-exit ((t (:foreground ,red-dark :weight bold))))
   `(transient-key-noop ((t (:foreground ,fg-faint))))
   `(transient-key-recurse ((t (:foreground ,violet :weight bold))))
   `(transient-key-return ((t (:foreground ,water-dark :weight bold))))
   `(transient-key-stack ((t (:foreground ,pink :weight bold))))
   `(transient-key-stay ((t (:foreground ,gold-dark :weight bold))))
   `(transient-mismatched-key ((t (:foreground ,red-dark :background ,bg-red :weight bold))))
   `(transient-nonstandard-key ((t (:foreground ,orange :weight semibold))))
   `(transient-unreachable ((t (:foreground ,fg-faint))))
   `(transient-unreachable-key ((t (:foreground ,fg-faint))))
   `(transient-value ((t (:foreground ,water-dark :weight bold))))
   ...
   ;; Third-party: magit-section
   `(magit-left-margin ((t (:foreground ,fg-dim :background ,bg-dim))))
   `(magit-section-child-count ((t (:foreground ,silver :weight normal))))
   `(magit-section-heading ((t (:foreground ,gold-dark :weight bold))))
   `(magit-section-heading-selection ((t (:foreground ,navy-dark :background ,bg-region :weight bold :extend t))))
   `(magit-section-highlight ((t (:background ,bg-active :extend t))))
   `(magit-section-secondary-heading ((t (:foreground ,violet :weight semibold))))

   ;; Third-party: Magit and git-commit
   `(git-commit-comment-action ((t (:foreground ,gold-dark :weight semibold))))
   `(git-commit-comment-branch-local ((t (:foreground ,navy :weight semibold))))
   `(git-commit-comment-branch-remote ((t (:foreground ,water-dark :weight semibold))))
   `(git-commit-comment-button ((t (:foreground ,water :underline t))))
   `(git-commit-comment-detached ((t (:foreground ,orange :weight semibold))))
   `(git-commit-comment-file ((t (:foreground ,water))))
   `(git-commit-comment-heading ((t (:foreground ,gold-dark :weight bold))))
   `(git-commit-keyword ((t (:foreground ,violet :weight semibold))))
   `(git-commit-nonempty-second-line ((t (:foreground ,red-dark :background ,bg-red :weight semibold))))
   `(git-commit-overlong-summary ((t (:foreground ,red-dark :background ,bg-red :weight semibold))))
   `(git-commit-summary ((t (:foreground ,navy-dark :weight bold))))
   `(git-commit-trailer-token ((t (:foreground ,violet :weight semibold))))
   `(git-commit-trailer-value ((t (:foreground ,water-dark))))

   `(git-rebase-action ((t (:foreground ,gold-dark :weight semibold))))
   `(git-rebase-comment-hash ((t (:foreground ,fg-faint))))
   `(git-rebase-comment-heading ((t (:foreground ,gold-dark :weight bold))))
   `(git-rebase-description ((t (:foreground ,fg-main))))
   `(git-rebase-hash ((t (:foreground ,violet))))
   `(git-rebase-killed-action ((t (:foreground ,red-dark :strike-through t))))
   `(git-rebase-label ((t (:foreground ,pink :weight semibold))))

   `(magit-bisect-bad ((t (:foreground ,red-dark :weight bold))))
   `(magit-bisect-good ((t (:foreground ,water-dark :weight bold))))
   `(magit-bisect-skip ((t (:foreground ,gold-dark :weight bold))))
   `(magit-blame-date ((t (:foreground ,fg-dim))))
   `(magit-blame-dimmed ((t (:foreground ,fg-faint))))
   `(magit-blame-hash ((t (:foreground ,violet))))
   `(magit-blame-heading ((t (:foreground ,navy-dark :background ,bg-alt :weight semibold :extend t))))
   `(magit-blame-highlight ((t (:foreground ,fg-main :background ,bg-active :extend t))))
   `(magit-blame-margin ((t (:foreground ,fg-dim :background ,bg-dim))))
   `(magit-blame-name ((t (:foreground ,water-dark))))
   `(magit-blame-summary ((t (:foreground ,fg-main))))

   `(magit-branch-current ((t (:foreground ,gold-dark :weight bold))))
   `(magit-branch-local ((t (:foreground ,navy :weight semibold))))
   `(magit-branch-remote ((t (:foreground ,water-dark :weight semibold))))
   `(magit-branch-remote-head ((t (:foreground ,water-dark :weight bold :box (:line-width -1 :color ,water)))))
   `(magit-branch-upstream ((t (:foreground ,lavender :weight semibold))))
   `(magit-branch-warning ((t (:foreground ,orange :weight bold))))
   `(magit-cherry-equivalent ((t (:foreground ,violet))))
   `(magit-cherry-unmatched ((t (:foreground ,water-dark))))

   `(magit-diff-added ((t (:foreground ,water-dark :background ,bg-blue :extend t))))
   `(magit-diff-added-highlight ((t (:foreground ,navy-dark :background ,bg-region :weight semibold :extend t))))
   `(magit-diff-added-indicator ((t (:foreground ,water-dark :background ,bg-blue :weight bold :extend t))))
   `(magit-diff-base ((t (:foreground ,gold-dark :background ,bg-active :extend t))))
   `(magit-diff-base-heading ((t (:foreground ,gold-dark :background ,bg-dim :weight semibold :extend t))))
   `(magit-diff-base-highlight ((t (:foreground ,gold-dark :background ,bg-region :weight semibold :extend t))))
   `(magit-diff-base-indicator ((t (:foreground ,gold-dark :background ,bg-active :weight bold :extend t))))
   `(magit-diff-conflict-heading ((t (:foreground ,violet :background ,bg-lavender :weight semibold :extend t))))
   `(magit-diff-conflict-heading-highlight ((t (:foreground ,violet :background ,bg-region :weight bold :extend t))))
   `(magit-diff-context ((t (:foreground ,fg-dim :background ,bg-main :extend t))))
   `(magit-diff-context-highlight ((t (:foreground ,fg-main :background ,bg-active :extend t))))
   `(magit-diff-file-heading ((t (:foreground ,navy-dark :weight bold :extend t))))
   `(magit-diff-file-heading-highlight ((t (:foreground ,navy-dark :background ,bg-active :weight bold :extend t))))
   `(magit-diff-file-heading-selection ((t (:foreground ,navy-dark :background ,bg-region :weight bold :extend t))))
   `(magit-diff-hunk-heading ((t (:foreground ,gold-dark :background ,bg-dim :weight semibold :extend t))))
   `(magit-diff-hunk-heading-highlight ((t (:foreground ,navy-dark :background ,bg-alt :weight bold :extend t))))
   `(magit-diff-hunk-heading-selection ((t (:foreground ,navy-dark :background ,bg-region :weight bold :extend t))))
   `(magit-diff-hunk-region ((t (:background ,bg-lavender :extend t))))
   `(magit-diff-lines-boundary ((t (:foreground ,navy-dark :background ,bg-search :weight bold :extend t))))
   `(magit-diff-lines-heading ((t (:foreground ,navy-dark :background ,bg-search :weight bold :extend t))))
   `(magit-diff-our ((t (:foreground ,red-dark :background ,bg-red :extend t))))
   `(magit-diff-our-heading ((t (:foreground ,red-dark :background ,bg-red :weight semibold :extend t))))
   `(magit-diff-our-highlight ((t (:foreground ,red-dark :background ,bg-orange :weight semibold :extend t))))
   `(magit-diff-our-indicator ((t (:foreground ,red-dark :background ,bg-red :weight bold :extend t))))
   `(magit-diff-removed ((t (:foreground ,red-dark :background ,bg-red :extend t))))
   `(magit-diff-removed-highlight ((t (:foreground ,red-dark :background ,bg-orange :weight semibold :extend t))))
   `(magit-diff-removed-indicator ((t (:foreground ,red-dark :background ,bg-red :weight bold :extend t))))
   `(magit-diff-revision-summary ((t (:foreground ,gold-dark :background ,bg-dim :weight semibold :extend t))))
   `(magit-diff-revision-summary-highlight ((t (:foreground ,navy-dark :background ,bg-alt :weight bold :extend t))))
   `(magit-diff-their ((t (:foreground ,water-dark :background ,bg-blue :extend t))))
   `(magit-diff-their-heading ((t (:foreground ,water-dark :background ,bg-blue :weight semibold :extend t))))
   `(magit-diff-their-highlight ((t (:foreground ,navy-dark :background ,bg-region :weight semibold :extend t))))
   `(magit-diff-their-indicator ((t (:foreground ,water-dark :background ,bg-blue :weight bold :extend t))))
   `(magit-diff-whitespace-warning ((t (:foreground ,red-dark :background ,bg-search :weight bold))))
   `(magit-diffstat-added ((t (:foreground ,water-dark :weight semibold))))
   `(magit-diffstat-removed ((t (:foreground ,red-dark :weight semibold))))

   `(magit-dimmed ((t (:foreground ,fg-faint))))
   `(magit-filename ((t (:foreground ,water))))
   `(magit-hash ((t (:foreground ,violet))))
   `(magit-head ((t (:foreground ,gold-dark :weight bold))))
   `(magit-header-line ((t (:foreground ,navy-dark :background ,bg-dim :weight bold :box (:line-width -1 :color ,border)))))
   `(magit-header-line-key ((t (:foreground ,gold-dark :background ,bg-dim :weight bold))))
   `(magit-header-line-log-select ((t (:foreground ,violet :background ,bg-dim :weight semibold))))
   `(magit-keyword ((t (:foreground ,violet :weight semibold))))
   `(magit-keyword-squash ((t (:foreground ,pink :weight semibold))))
   `(magit-log-author ((t (:foreground ,navy))))
   `(magit-log-date ((t (:foreground ,fg-dim))))
   `(magit-log-graph ((t (:foreground ,silver))))
   `(magit-mode-line-process ((t (:foreground ,gold-dark :weight semibold))))
   `(magit-mode-line-process-error ((t (:foreground ,red-dark :weight bold))))
   `(magit-process-ng ((t (:foreground ,red-dark :weight bold))))
   `(magit-process-ok ((t (:foreground ,water-dark :weight bold))))
   `(magit-reflog-amend ((t (:foreground ,pink))))
   `(magit-reflog-checkout ((t (:foreground ,navy))))
   `(magit-reflog-cherry-pick ((t (:foreground ,lavender))))
   `(magit-reflog-commit ((t (:foreground ,water-dark))))
   `(magit-reflog-merge ((t (:foreground ,violet))))
   `(magit-reflog-other ((t (:foreground ,fg-main))))
   `(magit-reflog-rebase ((t (:foreground ,gold-dark))))
   `(magit-reflog-remote ((t (:foreground ,water))))
   `(magit-reflog-reset ((t (:foreground ,red-dark))))
   `(magit-refname ((t (:foreground ,fg-main :background ,bg-dim :weight semibold))))
   `(magit-refname-pullreq ((t (:foreground ,violet :background ,bg-lavender :weight semibold))))
   `(magit-refname-stash ((t (:foreground ,pink :background ,bg-lavender :weight semibold))))
   `(magit-refname-wip ((t (:foreground ,ochre :background ,bg-active :weight semibold))))
   `(magit-sequence-done ((t (:foreground ,fg-faint))))
   `(magit-sequence-drop ((t (:foreground ,red-dark :strike-through t))))
   `(magit-sequence-exec ((t (:foreground ,violet :weight semibold))))
   `(magit-sequence-head ((t (:foreground ,gold-dark :weight bold))))
   `(magit-sequence-onto ((t (:foreground ,lavender :weight semibold))))
   `(magit-sequence-part ((t (:foreground ,fg-dim))))
   `(magit-sequence-pick ((t (:foreground ,water-dark :weight semibold))))
   `(magit-sequence-stop ((t (:foreground ,red-dark :weight bold))))
   `(magit-signature-bad ((t (:foreground ,red-dark :weight bold))))
   `(magit-signature-error ((t (:foreground ,red-dark :background ,bg-red :weight bold))))
   `(magit-signature-expired ((t (:foreground ,orange :weight semibold))))
   `(magit-signature-expired-key ((t (:foreground ,orange :weight bold))))
   `(magit-signature-good ((t (:foreground ,water-dark :weight bold))))
   `(magit-signature-revoked ((t (:foreground ,red-dark :strike-through t))))
   `(magit-signature-untrusted ((t (:foreground ,gold-dark :weight semibold))))
   `(magit-tag ((t (:foreground ,gold-dark :weight semibold))))

   ;; Third-party: diff-hl
   `(diff-hl-change ((t (:foreground ,gold-dark :background ,bg-active))))
   `(diff-hl-delete ((t (:foreground ,red-dark :background ,bg-red))))
   `(diff-hl-dired-change ((t (:foreground ,gold-dark :weight semibold))))
   `(diff-hl-dired-delete ((t (:foreground ,red-dark :weight semibold))))
   `(diff-hl-dired-ignored ((t (:foreground ,fg-faint))))
   `(diff-hl-dired-insert ((t (:foreground ,water-dark :weight semibold))))
   `(diff-hl-dired-unknown ((t (:foreground ,violet))))
   `(diff-hl-insert ((t (:foreground ,water-dark :background ,bg-blue))))
   `(diff-hl-margin-change ((t (:foreground ,gold-dark :background ,bg-active))))
   `(diff-hl-margin-delete ((t (:foreground ,red-dark :background ,bg-red))))
   `(diff-hl-margin-ignored ((t (:foreground ,fg-faint :background ,bg-dim))))
   `(diff-hl-margin-insert ((t (:foreground ,water-dark :background ,bg-blue))))
   `(diff-hl-margin-unknown ((t (:foreground ,violet :background ,bg-lavender))))
   `(diff-hl-reverted-hunk-highlight ((t (:foreground ,navy-dark :background ,bg-region :extend t))))
   `(diff-hl-show-hunk-posframe ((t (:foreground ,fg-main :background ,bg-main :box (:line-width 1 :color ,border)))))
   `(diff-hl-show-hunk-posframe-button-face ((t (:foreground ,water :underline t :weight semibold))))

   ;; Third-party: Vertico
   `(vertico-carousel-separator ((t (:foreground ,border :background ,bg-dim))))
   `(vertico-current ((t (:foreground ,navy-dark :background ,bg-region :weight semibold :extend t))))
   `(vertico-group-separator ((t (:foreground ,border :background ,bg-main :strike-through ,border :extend t))))
   `(vertico-group-title ((t (:foreground ,gold-dark :background ,bg-dim :weight bold :extend t))))
   `(vertico-indexed ((t (:foreground ,violet :weight semibold))))
   `(vertico-mouse ((t (:foreground ,navy-dark :background ,bg-active :extend t))))
   `(vertico-multiline ((t (:foreground ,fg-dim :slant italic))))
   `(vertico-quick1 ((t (:foreground ,gold-dark :background ,bg-search :weight bold))))
   `(vertico-quick2 ((t (:foreground ,violet :background ,bg-lavender :weight bold))))

   ;; Third-party: Consult
   `(consult-async-failed ((t (:foreground ,red-dark :weight bold))))
   `(consult-async-finished ((t (:foreground ,water-dark :weight semibold))))
   `(consult-async-option ((t (:foreground ,violet :weight semibold))))
   `(consult-async-running ((t (:foreground ,gold-dark :weight semibold))))
   `(consult-async-split ((t (:foreground ,pink :weight bold))))
   `(consult-bookmark ((t (:foreground ,gold-dark :weight semibold))))
   `(consult-buffer ((t (:foreground ,violet))))
   `(consult-file ((t (:foreground ,water-dark))))
   `(consult-grep-context ((t (:foreground ,fg-dim))))
   `(consult-help ((t (:foreground ,fg-dim :slant italic))))
   `(consult-highlight-mark ((t (:foreground ,pink :background ,bg-lavender :weight semibold))))
   `(consult-highlight-match ((t (:foreground ,navy-dark :background ,bg-search :weight bold))))
   `(consult-imenu-prefix ((t (:foreground ,gold-dark :weight bold))))
   `(consult-key ((t (:foreground ,navy :weight semibold))))
   `(consult-line-number ((t (:foreground ,silver))))
   `(consult-line-number-prefix ((t (:foreground ,fg-faint))))
   `(consult-line-number-wrapped ((t (:foreground ,orange :weight semibold))))
   `(consult-narrow-indicator ((t (:foreground ,gold-dark :background ,bg-active :weight bold))))
   `(consult-preview-insertion ((t (:foreground ,water-dark :background ,bg-blue :weight semibold))))
   `(consult-preview-line ((t (:foreground ,navy-dark :background ,bg-region :extend t))))
   `(consult-preview-match ((t (:foreground ,violet :background ,bg-lavender :weight bold))))

   ;; Third-party: Marginalia
   `(marginalia-archive ((t (:foreground ,orange))))
   `(marginalia-char ((t (:foreground ,pink))))
   `(marginalia-date ((t (:foreground ,gold-dark))))
   `(marginalia-documentation ((t (:foreground ,fg-dim :slant italic))))
   `(marginalia-file-name ((t (:foreground ,water-dark))))
   `(marginalia-file-owner ((t (:foreground ,navy))))
   `(marginalia-file-priv-dir ((t (:foreground ,navy :weight semibold))))
   `(marginalia-file-priv-exec ((t (:foreground ,water-dark :weight semibold))))
   `(marginalia-file-priv-link ((t (:foreground ,violet))))
   `(marginalia-file-priv-no ((t (:foreground ,fg-faint))))
   `(marginalia-file-priv-other ((t (:foreground ,pink))))
   `(marginalia-file-priv-rare ((t (:foreground ,orange :weight semibold))))
   `(marginalia-file-priv-read ((t (:foreground ,water-dark))))
   `(marginalia-file-priv-write ((t (:foreground ,gold-dark))))
   `(marginalia-function ((t (:foreground ,navy))))
   `(marginalia-installed ((t (:foreground ,water-dark :weight semibold))))
   `(marginalia-key ((t (:foreground ,gold-dark :weight semibold))))
   `(marginalia-lighter ((t (:foreground ,silver))))
   `(marginalia-list ((t (:foreground ,lavender))))
   `(marginalia-mode ((t (:foreground ,violet))))
   `(marginalia-modified ((t (:foreground ,orange :weight semibold))))
   `(marginalia-null ((t (:foreground ,fg-faint :slant italic))))
   `(marginalia-number ((t (:foreground ,ochre))))
   `(marginalia-off ((t (:foreground ,red-dark))))
   `(marginalia-on ((t (:foreground ,water-dark :weight semibold))))
   `(marginalia-size ((t (:foreground ,silver))))
   `(marginalia-string ((t (:foreground ,water-dark))))
   `(marginalia-symbol ((t (:foreground ,violet))))
   `(marginalia-true ((t (:foreground ,water-dark :weight semibold))))
   `(marginalia-type ((t (:foreground ,lavender))))
   `(marginalia-value ((t (:foreground ,water))))
   `(marginalia-version ((t (:foreground ,gold-dark))))

   ;; Third-party: Corfu
   `(corfu-annotations ((t (:foreground ,fg-dim))))
   `(corfu-bar ((t (:foreground ,gold-dark :background ,bg-alt))))
   `(corfu-border ((t (:foreground ,border :background ,border))))
   `(corfu-current ((t (:foreground ,navy-dark :background ,bg-region :weight semibold :extend t))))
   `(corfu-default ((t (:foreground ,fg-main :background ,bg-main))))
   `(corfu-deprecated ((t (:foreground ,red-dark :strike-through t))))
   `(corfu-echo ((t (:foreground ,fg-dim :background ,bg-dim :slant italic))))
   `(corfu-indexed ((t (:foreground ,violet :weight semibold))))
   `(corfu-popupinfo ((t (:foreground ,fg-main :background ,bg-dim :box (:line-width 1 :color ,border)))))
   `(corfu-quick1 ((t (:foreground ,gold-dark :background ,bg-search :weight bold))))
   `(corfu-quick2 ((t (:foreground ,violet :background ,bg-lavender :weight bold))))

   ;; Third-party: Embark
   `(embark-collect-annotation ((t (:foreground ,fg-dim))))
   `(embark-collect-candidate ((t (:foreground ,fg-main :background ,bg-main))))
   `(embark-collect-group-separator ((t (:foreground ,border :strike-through ,border :extend t))))
   `(embark-collect-group-title ((t (:foreground ,gold-dark :background ,bg-dim :weight bold :extend t))))
   `(embark-keybinding ((t (:foreground ,water-dark :weight semibold))))
   `(embark-keybinding-repeat ((t (:foreground ,gold-dark :weight bold))))
   `(embark-keymap ((t (:foreground ,violet :slant italic))))
   `(embark-selected ((t (:foreground ,navy-dark :background ,bg-region :weight semibold))))
   `(embark-sidebar-quick-key-face ((t (:foreground ,gold-dark :background ,bg-search :weight bold))))
   `(embark-target ((t (:foreground ,navy-dark :background ,bg-active :weight semibold))))
   ...
   `(embark-verbose-indicator-title ((t (:foreground ,gold-dark :weight bold :height 1.1))))

   ;; Third-party: Orderless (Cape itself defines no faces)
   `(orderless-match-face-0 ((t (:foreground ,gold-dark :weight bold))))
   `(orderless-match-face-1 ((t (:foreground ,water-dark :weight bold))))
   `(orderless-match-face-2 ((t (:foreground ,violet :weight bold))))
   `(orderless-match-face-3 ((t (:foreground ,pink :weight bold))))

   ;; Third-party: Tempel
   `(tempel-default ((t (:foreground ,fg-main))))
   `(tempel-field ((t (:foreground ,navy-dark :background ,bg-region :weight semibold))))
   `(tempel-form ((t (:foreground ,violet :background ,bg-lavender))))
   ))
